function add(){ // aggiunge un contatto alla rubrica   
    ...
    if(cognome.length>0 && nome.length>0 && indirizzo.length>0 && telefono.length>0){ //verifica se gli input dei campi del contatto non sono vuoti
        ...
        if(ind_cont != -1){                                                     //se abbiamo aggiunto il contatto aggiorno i campi 
...
function search(){                                                            //ricerco il contatto in base a cognome o telefono     
