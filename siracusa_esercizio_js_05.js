...
function start(){
    ...
    let risultato = prompt("Come ti chiami?", "Inserisci il tuo nome");
    let h1 = document.getElementsByTagName("h1");
    if(risultato && risultato != "Inserisci il tuo nome"){
        h1[0].innerText = "Benvenuto/a " + risultato + " nella pagina della media dei voti!!!";
    }
    else
